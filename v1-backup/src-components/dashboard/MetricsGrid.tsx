  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {metrics.map((metric, i) => (
        <div key={i} className="brand-card p-4 sm:p-5 flex flex-col justify-between">
          ...
          <div className="mt-4">
            ...
            <p className="text-2xl font-black text-[#111439] mt-1">{metric.value}</p>
