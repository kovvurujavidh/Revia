...
export default function SettingsPage() {
  ...
  const getRoleBadge = (role: string) => {
    switch (role) {
      case "owner":
        return "bg-[#6C4DFF]/10 text-[#6C4DFF] border-[#6C4DFF]/20";
      case "manager":
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-6 animate-fade-in">
      {/* Toast Feedback */}
      {savedToast && (
        <div className="fixed top-6 right-6 z-50 flex items-center gap-2 rounded-xl bg-[#16A34A] px-4 py-3 text-xs font-bold text-white shadow-lg animate-fade-in">
          <CheckCircle2 className="h-4 w-4" />
          <span>Settings saved successfully!</span>
        </div>
      )}
      {dataToast && (
        <div className="fixed top-6 right-6 z-50 flex items-center gap-2 rounded-xl bg-[#111439] px-4 py-3 text-xs font-bold text-white shadow-lg animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-black text-[#111439]">Business Settings</h1>
      ...
      <div className="space-y-6">
        ...
        <div className="brand-card p-6 sm:p-8">
          <div className="flex items-center gap-3 border-b border-[#E8E8ED] pb-4 mb-6">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#6C4DFF]/10 text-[#6C4DFF]">
              <Building2 className="h-5 w-5" />
            </div>
            <div>
              <h2 className="text-base font-bold text-[#111439]">Store Profile</h2>
          ...
          <form onSubmit={handleSaveProfile} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-[#E8E8ED] bg-[#F8F8F9] px-3.5 py-2.5 text-xs font-medium text-[#111439] focus:bg-white focus:border-[#6C4DFF] focus:outline-none"
                />
              </div>
            ...
            <div className="pt-3 flex justify-end">
              <button
                type="submit"
                className="inline-flex items-center gap-2 rounded-xl brand-gradient px-5 py-2.5 text-xs font-bold text-white shadow-sm hover:opacity-90 transition-opacity cursor-pointer"
              >
        ...
        <div className="brand-card p-6 sm:p-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E8E8ED] pb-4 mb-6">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#3B82F6]/10 text-[#3B82F6]">
                <Users className="h-5 w-5" />
              </div>
              <div>
                <h2 className="text-base font-bold text-[#111439]">Staff &amp; Permissions</h2>
                <p className="text-xs text-[#667085]">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl border border-[#E8E8ED] bg-white px-3.5 py-2 text-xs font-bold text-[#111439] hover:bg-gray-50 transition-colors shadow-2xs cursor-pointer"
            >
          ...
          <div className="divide-y divide-[#E8E8ED] rounded-xl border border-[#E8E8ED] overflow-hidden">
            ...
            <div className="flex items-center justify-between p-3.5 bg-white">
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#6C4DFF]/10 text-[#6C4DFF] font-bold text-xs">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-[#667085]">{activeBusiness.phone || activeBusiness.owner_email}</p>
                </div>
              </div>
            ...
            {staffMembers.map((member) => (
              <div
                key={member.id}
                className="flex items-center justify-between p-3.5 bg-white hover:bg-[#F8F8F9] transition-colors"
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#F8F8F9] text-[#111439] font-bold text-xs border border-[#E8E8ED]">
          ...
          {showInviteModal && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs p-4 animate-fade-in">
              <div className="w-full max-w-md rounded-2xl border border-[#E8E8ED] bg-white p-6 shadow-xl space-y-4">
                <div className="flex items-center justify-between border-b border-[#E8E8ED] pb-3">
                  <h3 className="text-sm font-bold text-[#111439]">Add New Staff Member</h3>
                  <button
                ...
                <form onSubmit={handleAddStaff} className="space-y-3.5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-[#E8E8ED] bg-[#F8F8F9] px-3 py-2 text-xs font-medium text-[#111439] focus:outline-none focus:border-[#6C4DFF]"
                    />
                  </div>
                  ...
                  <div className="pt-3 flex gap-2">
                    <button
                      type="button"
                      onClick={() => setShowInviteModal(false)}
                      className="flex-1 rounded-xl border border-[#E8E8ED] py-2 text-xs font-bold text-[#667085] hover:bg-[#F8F8F9] cursor-pointer"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className="flex-1 rounded-xl brand-gradient py-2 text-xs font-bold text-white shadow-xs hover:opacity-90 cursor-pointer"
                    >
                      Save &amp; Link Staff
                    </button>
                  </div>
        ...
        <div className="brand-card p-6 sm:p-8">
          <div className="flex items-center gap-3 border-b border-[#E8E8ED] pb-4 mb-6">
            ...
            <div>
              <h2 className="text-base font-bold text-[#111439]">WhatsApp Messaging Preferences</h2>
              <p className="text-xs text-[#667085]">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="w-32 rounded-xl border border-[#E8E8ED] bg-[#F8F8F9] px-3.5 py-2.5 text-xs font-bold text-[#111439] focus:bg-white focus:border-[#6C4DFF] focus:outline-none"
                />
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-[#E8E8ED] bg-[#F8F8F9] p-3.5 text-xs font-medium text-[#111439] focus:bg-white focus:border-[#6C4DFF] focus:outline-none"
              />
            </div>
          </div>
        </div>
        ...
        <div className="brand-card p-6 sm:p-8">
          <div className="flex items-center gap-3 border-b border-[#E8E8ED] pb-4 mb-6">
            ...
            <div>
              <h2 className="text-base font-bold text-[#111439]">Data Management &amp; Portability</h2>
              <p className="text-xs text-[#667085]">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-xl border border-[#E8E8ED] bg-white px-4 py-2.5 text-xs font-bold text-[#111439] hover:bg-gray-50 transition-colors shadow-2xs cursor-pointer flex-1"
            >
